...
export const timeConversions: Record<TimeUnit, Record<TimeUnit, number>> = {
	m: {
		...
		us: TimeConstants.MINUTES_TO_MICROSECONDS
	},
	s: {
		...
		us: TimeConstants.SECONDS_TO_MICROSECONDS
	},
	h: {
		...
		us: TimeConstants.HOURS_TO_MICROSECONDS
	},
	mo: {
		...
		us: TimeConstants.MONTHS_TO_MICROSECONDS
	},
	d: {
		d: 1,
		...
		us: TimeConstants.DAYS_TO_MICROSECONDS
	},
	w: {
		...
		us: TimeConstants.WEEKS_TO_MICROSECONDS
	},
	y: {
		...
		y: 1,
		us: TimeConstants.YEARS_TO_MICROSECONDS
	},
	ms: {
		...
		us: TimeConstants.MILLISECONDS_TO_MICROSECONDS
	},
	us: {
